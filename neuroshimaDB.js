...
const SKILLS_PACKAGES_NAMES_CONTROLLERS = [
    {"attr": "skill_hand_to_hand_combat", name: "Walka wręcz", nameIsReference: false, forSpec:["warrior"]},
    {"attr": "skill_driving", name: "Prowadzenie pojazdów", nameIsReference: false, forSpec:["technic"]},
    {"attr": "skill_manual_dexterity", name: "Zdolności manualne", nameIsReference: false, forSpec:["smarty"]},
    {"attr": "skill_firearms", name: "Broń strzelecka", nameIsReference: false, forSpec:["warrior", "ranger"]},
    {"attr": "skill_long_range_weapons", name: "Broń dystansowa", nameIsReference: false, forSpec:["warrior"]},
    {"attr": "skill_terrain_orientation", name: "Orientacja w terenie", nameIsReference: false, forSpec:["ranger"]},
    {"attr": "skill_perception", name: "Spostrzegawczość", nameIsReference: false, forSpec:["ranger"]},
    {"attr": "skill_camouflage", name: "Kamuflaż", nameIsReference: false, forSpec:["ranger", "smarty"]},
    {"attr": "skill_survival", name: "Przetrwanie", nameIsReference: false, forSpec:["ranger"]},
    {"attr": "skill_negotiation", name: "Negocjacje", nameIsReference: false, forSpec:["smarty"]},
    {"attr": "skill_empathy", name: "Empatia", nameIsReference: false, forSpec:["smarty"]},
    {"attr": "skill_willpower", name: "Siła woli", nameIsReference: false, forSpec:["warrior"]},
    {"attr": "skill_medicine", name: "Medycyna", nameIsReference: false, forSpec:["technic", "ranger"]},
    {"attr": "skill_technology", name: "Technika", nameIsReference: false, forSpec:["technic"]},
    {"attr": "skill_equipment", name: "Sprzęt", nameIsReference: false, forSpec:["technic"]},
    {"attr": "skill_pyrotechnics", name: "Pirotechnika", nameIsReference: false, forSpec:["technic"]},
    {"attr": "skill_general_knowledge", name: "Wiedza ogólna", nameIsReference: false, forSpec:["warrior", "technic"]},
    {"attr": "skill_fitness", name: "Sprawność", nameIsReference: false, forSpec:["ranger"]},
    {"attr": "skill_equestrianism", name: "Jeździectwo", nameIsReference: false, forSpec:["ranger"]},
]