...
const SKILLS_NAMES_CONTROLLERS = [
    {"attr": "skill_brawl", name: "Bijatyka", nameIsReference: false},
    {"attr": "skill_handheld_weapon", name: "Broń ręczna", nameIsReference: false},
    {"attr": "skill_throwing", name: "Rzucanie", nameIsReference: false},
    {"attr": "skill_car", name: "Samochód", nameIsReference: false},
    {"attr": "skill_motorcycle", name: "Motocykl", nameIsReference: false},
    {"attr": "skill_truck", name: "Ciężarówka", nameIsReference: false},
    {"attr": "skill_pickpocketing", name: "Kradzież kieszonkowa", nameIsReference: false},
    {"attr": "skill_lockpicking", name: "Otwieranie zamków", nameIsReference: false},
    {"attr": "skill_agile_hands", name: "Zwinne dłonie", nameIsReference: false},
    {"attr": "skill_pistols", name: "Pistolety", nameIsReference: false},
    {"attr": "skill_rifles", name: "Karabiny", nameIsReference: false},
    {"attr": "skill_machine_guns", name: "Broń maszynowa", nameIsReference: false},
    {"attr": "skill_bow", name: "Łuk", nameIsReference: false},
    {"attr": "skill_crossbow", name: "Kusza", nameIsReference: false},
    {"attr": "skill_sling", name: "Proca", nameIsReference: false},
    {"attr": "skill_direction_sense", name: "Wyczucie kierunku", nameIsReference: false},
    {"attr": "skill_trap_preparation", name: "Przygotowanie pułapki", nameIsReference: false},
    {"attr": "skill_tracking", name: "Tropienie", nameIsReference: false},
    {"attr": "skill_listening", name: "Nasłuchiwanie", nameIsReference: false},
    {"attr": "skill_spotting", name: "Wypatrywanie", nameIsReference: false},
    {"attr": "skill_alertness", name: "Czujność", nameIsReference: false},
    {"attr": "skill_sneaking", name: "Skradanie się", nameIsReference: false},
    {"attr": "skill_hiding", name: "Ukrywanie się", nameIsReference: false},
    {"attr": "skill_disguise", name: "Maskowanie", nameIsReference: false},
    {"attr": "skill_hunting", name: "Łowiectwo", nameIsReference: false},
    {"attr": "skill_terrain_knowledge", name: "Znajomość terenu", nameIsReference: false},
    {"attr": "skill_water_acquisition", name: "Zdobywanie wody", nameIsReference: false},
    {"attr": "skill_intimidation", name: "Zastraszanie", nameIsReference: false},
    {"attr": "skill_persuasion", name: "Perswazja", nameIsReference: false},
    {"attr": "skill_leadership", name: "Zdolności przywódcze", nameIsReference: false},
    {"attr": "skill_emotional_perception", name: "Postrzeganie emocji", nameIsReference: false},
    {"attr": "skill_bluff", name: "Blef", nameIsReference: false},
    {"attr": "skill_animalcare", name: "Opieka nad zwierzętami", nameIsReference: false},
    {"attr": "skill_toughness", name: "Odporność na ból", nameIsReference: false},
    {"attr": "skill_resolve", name: "Niezłomność", nameIsReference: false},
    {"attr": "skill_morale", name: "Morale", nameIsReference: false},
    {"attr": "skill_first_aid", name: "Pierwsza pomoc", nameIsReference: false},
    {"attr": "skill_wound_treatment", name: "Leczenie ran", nameIsReference: false},
    {"attr": "skill_disease_treatment", name: "Leczenie chorób", nameIsReference: false},
    {"attr": "skill_mechanics", name: "Mechanika", nameIsReference: false},
    {"attr": "skill_electronics", name: "Elektronika", nameIsReference: false},
    {"attr": "skill_computers", name: "Komputery", nameIsReference: false},
    {"attr": "skill_heavy_machinery", name: "Maszyny ciężkie", nameIsReference: false},
    {"attr": "skill_military_vehicles", name: "Wozy bojowe", nameIsReference: false},
    {"attr": "skill_boats", name: "Kutry", nameIsReference: false},
    {"attr": "skill_gunsmithing", name: "Rusznikarstwo", nameIsReference: false},
    {"attr": "skill_launchers", name: "Wyrzutnie", nameIsReference: false},
    {"attr": "skill_explosives", name: "Materiały wybuchowe", nameIsReference: false},
    {"attr": "skill_general_knowledge1", name: "skill_general_knowledge1_text_input", nameIsReference: true},
    {"attr": "skill_general_knowledge2", name: "skill_general_knowledge2_text_input", nameIsReference: true},
    {"attr": "skill_general_knowledge3", name: "skill_general_knowledge3_text_input", nameIsReference: true},
    {"attr": "skill_endurance", name: "Kondycja", nameIsReference: false},
    {"attr": "skill_swimming", name: "Pływanie", nameIsReference: false},
    {"attr": "skill_climbing", name: "Wspinaczka", nameIsReference: false},
    {"attr": "skill_horseback_riding", name: "Jazda konna", nameIsReference: false},
    {"attr": "skill_horse_driving", name: "Powożenie", nameIsReference: false},
    {"attr": "skill_dressage", name: "Ujeżdżanie", nameIsReference: false},
]

const SKILLS_PACKAGES_NAMES_CONTROLLERS = [
    {"attr": "skill_hand_to_hand_combat", name: "Walka wręcz", nameIsReference: false},
    {"attr": "skill_driving", name: "Prowadzenie pojazdów", nameIsReference: false},
    {"attr": "skill_manual_dexterity", name: "Zdolności manualne", nameIsReference: false},
    {"attr": "skill_firearms", name: "Broń strzelecka", nameIsReference: false},
    {"attr": "skill_long_range_weapons", name: "Broń dystansowa", nameIsReference: false},
    {"attr": "skill_terrain_orientation", name: "Orientacja w terenie", nameIsReference: false},
    {"attr": "skill_perception", name: "Spostrzegawczość", nameIsReference: false},
    {"attr": "skill_camouflage", name: "Kamuflaż", nameIsReference: false},
    {"attr": "skill_survival", name: "Przetrwanie", nameIsReference: false},
    {"attr": "skill_negotiation", name: "Negocjacje", nameIsReference: false},
    {"attr": "skill_empathy", name: "Empatia", nameIsReference: false},
    {"attr": "skill_willpower", name: "Siła woli", nameIsReference: false},
    {"attr": "skill_medicine", name: "Medycyna", nameIsReference: false},
    {"attr": "skill_technology", name: "Technika", nameIsReference: false},
    {"attr": "skill_equipment", name: "Sprzęt", nameIsReference: false},
    {"attr": "skill_pyrotechnics", name: "Pirotechnika", nameIsReference: false},
    {"attr": "skill_general_knowledge", name: "Wiedza ogólna", nameIsReference: false},
    {"attr": "skill_fitness", name: "Sprawność", nameIsReference: false},
    {"attr": "skill_equestrianism", name: "Jeździectwo", nameIsReference: false},
]